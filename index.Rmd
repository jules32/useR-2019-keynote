...
knitr::include_graphics("img/*IMG_9268.JPG") 
```
]
...
knitr::include_graphics("img/*JulieReleaseAugerIMG_9397.jpg") 
```
]
...
<br>
<br>
```{r fieldwork, out.width = '100%', fig.align='center'}
knitr::include_graphics("img/DannaJulieAshleyNOAA.JPG")  
```

]
.pull-right[
```{r fieldwork2, out.width = '80%', fig.align='center'}
...
---
```{r yoda, out.width = '90%', fig.align='center'}
...
This started off as just being informal chats in our research group about data and workflows.
...
knitr::include_graphics("img/rladiessb-streamlined.jpg")  
```
]

.pull-right[
```{r rladiessb, out.width = '100%', fig.align='center'}
knitr::include_graphics("img/rladies-kickoff.jpg") 
```
]


.footnote[
tweet: [@i_steves](https://twitter.com/i_steves/status/983909123073835010)
]
