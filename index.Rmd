...
This includes a deliberate focus on creating a safe and welcoming space. The program is led remotely, so we use the internet and software to connect with each other through video calls and through a shared Google Doc. 
...
Some labs have also done hackathons, like we do in Ocean Health Index, where we will all drop our own projects and come together for a day or an afternoon to do something that will benefit the whole group, like upgrading our filepath strategies with the "here" package. 
...
transition: and I'm convinced it's the way to help scientists find ways to engage with this powerful feedback loop


---
class: middle, center
```{r loop3, out.width = '100%'}
knitr::include_graphics("img/horst-lowndes-loop.png")
```
...
transition: and I'm so proud of what we've accomplished with Openscapes.
...
There are so many more examples of their accomplishments and momentum. 

I am so proud of them. They are shifting mindsets and practice when it comes to open data science and teamwork, and they are igniting change in their labs, and in their departments, their campuses, and beyond. 
...
But we have a long way to go before this is is truly the reality in science

The Champions will be visible examples and ambassadors for change, and there will be more and more of them. 

I am working to continue to grow the program so that I can lead annual cohorts and also lead on-demand workshops.  

I'd love you all to be a part of this; I think that by welcoming and amplifying more environmental scientists, we can increase the visibility and value of open data science in environmental science as well, and really change towards better science in less time. 
...
We can continue to strengthen our community by welcoming and amplifying awesome environmental scientists, so that we can do better science in less time, together. 
