...
To make this a reality we need to not only welcome more environmental scientists to the R community, but also simultaneously extend our values and our ethos to the environmental science community.

It requires changes in mindset for individuals to make change in the culture as a whole, but I know it is possible because I have lived through this mindset change myself, and I have spent the last 6 years igniting cultural change in environmental science. 
...
We started having seaside chats just amongst us, where we would meet to learn new tools toagethere, establish SOPs, and shared practices to help onboard new team members. 
...
But it took us 4 years to learn how to work as a team and use open data science tools. 

So how do we make it so that it isn't such a painful and long process for other labs?
...
With Openscapes I want to create more entryways for environmental scientists to participate in this loop and do better science in less time. 

Openscapes is a mentorship program for teams. I mentor scientific research groups and help them engage in team work and open data science. 

<!---just like my PhD lab with squid--->

<!---
The goal is to complement existing efforts like the Carpentries, RStudio, rOpenSci and help welcome more scientists to them.
--->
...
I designed Openscapes to recreate what was so critical to us with OHI. 

I mentor the leaders and team members together so everyone sees the value and power of what's possible.

Leaders, who likely do not have time to learn everything themselves, feels comfortable letting their research groups develop these skillsets, and the lab members have agency and paths forward for what to do. 

transition: I piloted this program earlier this year, with 7 early career faculty and lecturers in environmental science. 
...
I selected these leaders because they are already really impactful science and have a lot of visibility and influence in their disciplines, and also because they were not already engaged in open data science. The idea is that by helping them do better science in less time, they can help be amplifying voices for why this is so important, and help change the culture as a whole. 
...
And here are all of their labs!

Mentorship happens remotely, with all 7 leaders and their research groups on the same Zoom call together. I teach different concepts and we're able to have full-group discussions and do virtual break-out groups where we mix up lab groups and have them discuss how these concepts could be integrated into their work.

---
# screenshot call agenda

???

In each call we also use Google Docs to type notes and share links. Each call starts off with Community Participation Guidelines or Code of Conduct
