...
So with Openscapes I'm trying to reduce the time it takes to discover this feedback loop by listening to scientists and welcoming them to engage in a way that works for their lab.
...
And I am working to continue to develop and grow the program so that I can lead cohorts every year and begin on-demand workshops with teams on the ground. If you're interested in getting involved I would love to hear from you.   

We do have a long way to go before this is is truly the reality in science.

Completing this picture this requires more support for environmental scientsts within science itself, so that they are not learning about open data science in pockets of opportunity and on their own time, but instead learn as part of their education, and are supported as scientists. 

But I am optimistic that the more visible it is that environmental scientists are working with open data science practices, the more we will value it in science and we can increase its value and help change this cutlture as a whole. 
...
We can all do our part to welcome and amplify these awesome environmental sicnetists as they in engage in R and join our community, so that we all can benefit from better science in less time. 
