...
And then also this. And what does that look like in Data science? In env science, using the force is what we do for open data science. END WITH AWESEOME STATEMENT
R is the force and 
