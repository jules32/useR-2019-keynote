...
.footnote[
twitter: [@ecodatasci](https://twitter.com/ecodatasci); [@RLadiesSB](https://twitter.com/RLadiesSB)
]
...
.footnote[
web: [Mozilla Open Leaders](https://foundation.mozilla.org/en/opportunity/mozilla-open-leaders/) (OLX applications due August 1!)
]
...
This includes a deliberate focus on creating a safe and welcoming space that Openscapes cohorts take back to their labs. 

to talk about easing into open data science. 


We talk about tools and strategies, but also share our vulnerabilities. 

We talk about how unconfortable it can be to try to instill best practices in your lab when you don't know what they are. 

Or how.

And we also share awesome wins like XYZ. 

---
their homework is meet regularly with just their lab group to start weaving these practices into their every day work and start to seed this culture more broadly at their universities.
