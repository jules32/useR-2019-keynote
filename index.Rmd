...
OHI intro and explanation is too long. Indicators are good ways doesn't mean much if you don't know waht they are. TOO long on what it is. 
Only thing: we're trying to on a global scale trying to better understand and quatnify the health of our oceans. that's a massive
"this is a really massive novel sicnetific undertaking but for us, it also meant to do sound and reproducible data science". And in order to do the big questions with the science, we had to get our ducks in a row for data science. 
"OHI is used by UN to try to quantify impacts and benefits" << that shuld be their takehome

Do I want to sell the pub of this story of our pub: we were not the only people struggling with this. No let's keep it here. We had a pub.

What are our secrets section: like it but didn't work
those secrets seem vague. People want concrete things. 
It's OK if I say those things later on. Have a preview 
Move those. 
Before we did this data science updates stuff this is what people like. But those secrets put this at the end. Now I've told you about the tech advances. but what actually was some of thee intangible things that made these madssive change spossible
...
This is all what enabled openscapes, Bommer awesome streamline intro to how do we breakdown those barriers and entryways. 
...
But that's really easy to say: "change these thigns" but what are the intangible and really ciritacl things: 
it came down to 5 things: 
leader 
working as a team
jazzed about R
twitter
joining and participating in broader communities
...
Studies like these make it seem that science is a uniformed effort that streamlines data into results.
