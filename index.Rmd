...
R not only made it easier do analyses better, but also has been game-changing for communication and culture and what we think is possible. 
...
The Ocean Health Index is a program to measure what we value about our oceans using the best available data and science. 
...
But when we realized we had a story to tell with how these tools let us do better science in less time.
...
This is how we had been working to do this study with 100 data sets. 

We truly thought that this would be reproducible, and knew that we ourselves would be redoing this whole effort the next year, and for every year after that. 

So it was also really deflating and embarassing that it was not. 

And we had deadlines and pressures to keep, and it just seemed really unattainable, like getting that plane out of the swamp.  
...
A second thing is that we had someone on our team that was really jazzed about R and willing to patiently teach us

And the third and really importantly we had a team lead who saw value in us investing time and resources
...
It was definitely making my analytical life better but it hadn't completely changed my life.
...
But then 2 important things happened: we joined Twitter and went to an rOpenSci unconf. 

I had never used Twitter before, so I was definitely skeptical. I thought it was a megaphone, I didn't realize it was a place to have thoughtful conversations with people, and most of all is is a way to connect with others and to listen and learn. 

On Twitter I was amazed that I could learn from and interact with coders and developers. I was really blown away that developers were real people, and real people that were super nice and that we could talk with. My experience with software before that had not really had a person behind it — 
...
But it turns out, R developers are way more awesome than Clippy. 

At the rOpenSci conf, we met Karthik and Joe and Hadley and other folks in person.

It was a big deal to be feel so welcomed here, and it really broadened my thinking of of what community is and what teamwork is. 

I really started feeling that this was more than code, it was a better way to work and a better way to do science. 

transition: this was really the defining point where I became that person that would not stop talking about how life-changing R and open science and the R community is 
...
A main thng I've realized is that data science and teamwork exist together in a feedback loop. 
...
If this cool feedback loop that we've found successful doesn't exist, how do you create it? 

And if someone is outside of it, how do you welcome them?

transition: And that's really the motivation behind Openscapes.
---
# Openscapes hex, center

???

So with Openscapes, I'm really trying to figure out how to engage and welcome scientists scientists to data science, and do so in a lasting way through teamwork.  

And to Increase the visibility of open practices
...
The main part of Openscapes is a mentorship program that I call the Champions program, to welcome scientists to data science and create more champions for data science, open practices, and team work. 
...
I just piloted the Champions mentorship program as a 5 month program online. We just completed this first cohort with 7 labs. 
...
intro to tools like the tidyverse and friends, GitHub issues, markdown. This is the only thing we do hands on: to smooth communication and culture

The point is to really help create these mindset and culture shifts
...
But what I realized quickly was there was work to be done on the teamwork side first. 
...
???
This is the Pinsky Lab, they study global change ecology and evolution in the sea. They are doing really high impact work using population genomics and modeling
