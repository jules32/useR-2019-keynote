...
Excel was the only tool I knew, and it wouldn't work because file was too big. 

This was not big data in the way that many of of you consider big data, but it was big to me, and it was panic-inducing. 

I actually considered breaking the dataset into multiple excel files and analyzing each by hand. It was a really dark time. 

But it gets better. 

I like to talk about it with analogies from Star Wars.
...
transition: Some of the ways I've been doing this is through —
...
exclude: TRUE
# Seaside chats
```{r seaside, out.width = '70%', fig.align='center'}
knitr::include_graphics("img/seaside-chat.jpg") 
```
...
We call these seaside chats. The name comes from Roosevelt's Fireside chats, where he would share his thought process, daylighting all of his decisions and opening them up for examination.

Our chats are focused on setting up and maintaining standard operating procedures for our research group. We learn new skills and discuss folder architecture, filenaming, and code. 
...
I became an instructor with the Carpentries, which has been such a valuable thing for me, because previously I have never been taught how to teach or think about how people learn. . 


This is a group that skill-shares....

and I have now led 7 workshops. 
...
.pull-right[
```{r fellows, out.width = '80%', fig.align='center'}
knitr::include_graphics("img/") 
```
...
and I've led 2 training programs for the OHI;
...
---
# openscapes grassland w hex

???

and through all of this I've been thinking about what the problem is in environmental science and trying to identify identify where I can be most effective. And for me, I think that's what I'm doing with Openscapes. 
...
transition: Her results help inform policy and management decisions around food systems, disease transmission, sustainability, and climate change. 
...
This picture here is the way science works right now, and what our education looks like. We are really good at theory, developing hypotheses, and experimental design. And we are getting better and better at communication and helping our findings get to the right audiences.

But there is this huge missing part here in the middle.

In the past, we got by filling this in as individuals creating our own homegrown approaches and not reporting about data methods in detail. 

But that is not working now: our data challenges have gotten bigger and faster and we are not prepared. 
...
A big part of openness is helping scientists identify teams and create teams and join teams.
// think about teamwork, which means identifying people that they can work with. Redefini

Teams can be the colleagues in your office with the same deliverables, they can be 

Teams are important no one can do it all. 
...
I'm going to talk through how our team operates, because with Openscapes I'm mentoring resarch groups to help them replicate this for themselves.
...
???
I mentioned seaside chats before, which is really critical for establishing shared workflows. But is is also critical for teambuilding. They are fun. It's a time for us to discuss things we've learned etc.  . 
...
We also have coopted the idea of hackathons, where we will all drop our own projects and come together for a day or an afternoon to do something that will benefit the whole group. 
...
He has played a huge role in our data science story... MEDS will start in Aug 2020
...
???
Community for me has really been redefined. env sci, R, and moz communities.
...
Realizing this really was defining point in my life. 
...
transition: so much so that even my 3 year old niece knew that Hadley was wizard who lived on the internet
...
This has made me be a better advocate for women in science. And this is something that we discuss in Openscapes too. 
...
I mentioned RLadies and Eco-data-science
...
I've modeled what I teach in openscapes after our experience with OHI,

And I modeled program architecture after Mozilla's Open Leaders program. This architecture includes deliberate focus on welcoming people and creating safe spaces. 
