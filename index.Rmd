...
For my PhD work I worked across domains like oceanography, fisheries, and behavioral ecology. 
...
But, we need to be honest that we are not learning the skills we need to work responsibly with data. Our culture as a whole does not value data science and open practices when we do not have any time to waste. 

transition: And I am convinced that R can help here. 

---
# #rstats can help increase visibility & value
<!---Not valued <-> not visible
Right now it's this feedback loop where it is not valued, so it is not visible, and because it is not visible, it is not valued. 

And I think this also offers our best opportunity for change. 

If we can increase its visibility
--->
...
I think the problem is that data science is not valued, which as I said means it is not taught or supported. 
...
transition: but luckily R can help with individual skillsets and mindsets, and the collective culture as a whole. 
...
It does this because there are norms for functions and styles, and norms for the community. 
...
We talk a lot about the R community and welcoming more people into it, which I wholey support and actively do. I want to simultaneously welcome new community memebers and also extend our values and our ethos to other communities as well. 

transition: So I want to focus on culture shift that needs to happen so that we value data science and open practices in the environmental science community. 
...
So over the past year with my Mozilla Fellowship, I've developed a program called Openscapes.
...
Takehomes are that it's all about teams and community, and we as individuals can play leadership roles of all kinds. 
