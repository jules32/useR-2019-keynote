...
I think the power of welcome, as Stef Butland would call it, is the way to go. 
...
How we welcome them into this world of data science and teamwork, no matter matter where they are starting from. 

Over the last 6 years I've been informally mentoring friends and colleagues — if that's what you can call being relentless in talking about R and open science all the time. 

But listening to scientists and understanding how they work and what challenges they have about data has really paved the way for Openscapes. 

transition: With Openscapes I've created more formal mentorship program, but it essentially does this — welcomes more scientists into our community and extends it into other communities as well. 
