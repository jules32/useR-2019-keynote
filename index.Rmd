...
The challenge I'm dedicated to is helping environmental scientists do better science in less time. And by that I mean science that is more efficient, reproducible, and can help uncover solutions faster to our greatest environmental challenges. 

Throughout my work, I have a few lessons learned JENNY and I'm going to share them upfront. 

They are guiding principles for me, and what I advise environmental scientists. And they are relevant much more broadly so I expect they will be useful for everyone here as as well. 
...
### Harness the power of welcome JENNY
...
But before we get to this let me start off with a bit about me and and my origins as a marine scientist. 

Before I became a scientist, I always thought science was a pretty streamlined and unified effort. 

But really, science operates in pockets, with groups of scientists working within research groups, which we also call laboratories in the United States.
...
//It complements existing efforts like the Carpentries and //

It addresses one of the biggest chllenges I've seen which is how to establish and maintain shared practices as a team.
...
### expect a better way • build confidence & willingness JENNY
...
???
Build confidence together as a team. You can work openly with your reearch group even if it is private to the rest of the world. because this is a step along that spectrum.
...
---
# efficiency tips TODO

we pepper this with little wins that can have huge impact. I show keyboard shortcuts


---
.whisper[open data science is data science that enables open science]
...
This is the definition from our publication. But honestly to me at this point it is too narrow of a definition. 

Because it doesn't say anything about teamwork. 
...
The OHI focuses on the benefits that the ocean provides people, and we use the best available data to model ocean health scores around the world. 
...
We repeat this every year and it's being used by the United Nation to track progress towards environmental targets, which is really exciting. 
