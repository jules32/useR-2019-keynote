...
The Ocean Health Index, which we call OHI, is the research group I've worked with for the past six years. 

This is a big project where we are trying on a to better understand and quantify the health of our oceans on a global scale, as well as at smaller spatial scales. 

To make this useful and actionable for policy, the OHI focuses on how the ocean provides benefits to people, modeled with the best publically available data and science. 
...
<br>
<br>
```{r lukesmall, out.width = '100%', fig.align='center'}
...
transition: but we did figure it out —
...
and open data science has empowered us do better science in less time. 
...
i'll stop there but also shared resources that helped us learn and strategies. nssd.
...
# Teamwork
<br>
# Working openly as a team
# Leadership
# Community (redefined)

???
I'm going to call this teamwork its a work in progress

working openly as a team. trust. willingness.
positive/supported leadership. gave us space to learn, in a way its hir. let us become leaders too. horizontally w eo and lead from within. And lead outside, which is the next point

comm redefined, beyond ocean health or marine science
...
really opened my eyes that i could extend this ethos and be a more supportive in science.
...
As th ohi team, It took us 4 years to learn how to work as a team and use open data science tools. 
...
What ive seen is that openscapes mentorship and creating a welcoming space for scientists across research groups can help complete this pic open data science and teamwok 

A way to be aware of whats possible and build conf that it is possible to engage, no matter the starting point, and to create safe spaces to learn and innovate together.

And that is critical: part of better sci in less time is better for people.
...
I'm excited about it and even as this program is being developed something i'm committed to, with that in mind (web and book) .
...
Openscapes is fueled by Rmd. this web with blogdown, and these slides with xaringan. Additionally, the book is in bookdown. 
