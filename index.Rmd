...
And as I walk through these lessons I'll weave examples from all these experiences, but focused on the OHI and Openscapes. 
...
---
# Zoom woot! <img src="img/openscapes-hex.png" alt="rstudio" style="float:right;width:100px;"/>
...
Example: Nishad couldn't come but his students. 
...
This is Ben Best, Jamie Afflerbach and me. They have been so leaders for me and partners in crime as well. 

and we co-founded EDS with other friends and have taught multiple carpentries workshops together. This is us preparing for the Shiny conference in 2016. 
...
ADD THIS TODOand see notes below
...
the communities we're in here have grown out of the interest in the tools. but that's not the entryway for everyone. I've been focused on the reverse process, trying to create solid teams that are stronger because of ods.  OPENSCAPES IS DESIGNED FOR PARTICIPANTS OUTSIDE OF THIS LOOP.
...
So they see the benefit more, but no TIME ~or INCENTIVE~. 
