...
THis is our story about our path to bsilt using R, RStudio, Git and GitHub. We describe how we made this shift when we faced a reckoning that the way we were doing data analysis was not reproducible even by ourselves.

We also describe the resources of what helped us learn, which include so many great resources but I wanted to specifcally mention how impactful the NSSD podcast was for me, because I never imagined you could talk about data in so many interesting ways. 

---
# <img src="img/mozilla-vertical.png" alt="mozilla" style="float:right;height:154px;"/>
```{r moz, out.width = '90%', fig.align='center'}
knitr::include_graphics("img/SpringMorrisPhoto_Mozilla_Fellow_32A9764.jpg")  
```

.footnote[
blog: [mozilla](https://blog.mozilla.org/blog/2018/08/21/mozilla-announces-25-new-fellows-in-openness-science-and-tech-policy/)
]
...
---
```{r champions-web, out.width = '80%', fig.align='center'}
...
For the Ocean Health Index, these tools have redefined how we think about communication. 

We have reimagined what's possible for science because we are able to  communicate throughout the whole process rather than only at the end. 

<next go quickly>

--
.pull-left[
```{r ohi-science-github, out.width = '100%', fig.align='center'}
...
.pull-right[
```{r ohi-science-homepage, out.width = '100%', fig.align='center'}
knitr::include_graphics("img/ohi-science-homepage.png") 
```

.footnote[
web: [ohi-science.org](http://ohi-science.org)
]
]

???

We do everything online, and mostly publicly. Not just all our code and data are online throughout the process 

---
.pull-left[
```{r rmd-fellows-web, out.width = '100%', fig.align='center'}
knitr::include_graphics("img/")
```

.footnote[
web (simple RMarkdown): [ohi-science.org/globalfellows](http://ohi-science.org/globalfellows)
]
]

.pull-right[
```{r blogdown-openscapes, out.width = '90%', fig.align='center'}
knitr::include_graphics("img/") 
```
...
We have become web developers

---
class: center, middle
.pull-left[
```{r ds, out.width = '100%', fig.align='center'}
knitr::include_graphics("img/data-science-training-book.png")
```

.footnote[
web: [ohi-science.org/data-science-training](http://ohi-science.org/data-science-training/)
]
]

.pull-right[
```{r openscapes-series, out.width = '90%', fig.align='center'}
knitr::include_graphics("img/openscapes-series.png") 
```

.footnote[
book: [openscapes.org/series](https://openscapes.github.io/series)
]
]
...
.footnote[
dashboard: [@jafflerbach](https://twitter.com/jafflerbach), work in progress. 
inspiration: [Imagine Boston](https://analytics.boston.gov/app/imagine-boston) 
]

???

And dashboard creators 
...
.footnote[
web: [ohi-science.org](TODO link to OHI+ page, maybe BHI archive?
]
...
The circlese show it took less time every year and also along the axes it was easier to reproduce and easier to collaborate with our future selves, which means Future Me and also Future Us. 
...
Teamwok and collaboration are such powerful things for innovation as well as for emotional well-being. And that is because no one can do it all, and we need to shed the expectation that we should. 
...
---
class: center, middle
# trust <br> assume best intentions

???

it means we trust each other, and we assume best intentions, so critique comes from the intent of making it better. 
...
# don't let perfect <br> be the enemy of the good

???

it's about getting comfortable with imperfection and knowing when it has to be good enough. 

---
class: center, middle
# ask for help <br> accept help

???

it's about asking for help and accepting help. is a balance. helps shatter that we should do it all. This is something I really struggle with, but I'm working on. Putting together this talk is a great example of me trying to be better at both, thanks 
...
That means work-life balance, respecting each other's time.

transition: so how do you create this?

???

---
# Reflection, communication, iteration
...
- start and end meetings on time. try to be realistic with deadlines
...
OL is... created by Mozilla Science Labs and Open Leadership and Events team.
...
transition: in Openscapes, we do 3/4 things

---
# Seaside Chats & Lab Hackathons
and CoCs

.footnote[
blog: [openscapes.org](https://www.openscapes.org/blog/2019/03/10/seaside-chats/)

???

TODO lang SEE BELOW TOO
...
exclude: TRUE 
TODO fig out here
THIS IS NOW A REPEAT TODO BC IN INTRO
# <img src="img/openscapes-hex.png" alt="rstudio" style="float:right;width:100px;"/>
...
.footnote[
twitter: [stuart620](https://twitter.com/stuart620); [RLadiesHPNJ](https://twitter.com/RLadiesHPNJ)
]
...
---
class: center, middle
```{r adrian-sam-tweet, out.width = '82%'}
knitr::include_graphics("img/tweet-adrianstier-rladies.png") 
```

.footnote[
tweet: [@adrianstier](https://twitter.com/AdrianStier/status/1129097395176738816)
]
...
So these lessons I think fuel what it means to work responsibly and collaboratively with data but also as humans. 

and should also fuel what it means to do science. 
...
In Openscapes, I talk about how open data science has made the internet become my external memory, fueled by Google and GitHub search. 

As I find things that are useful to me I try to leave little breadcrumbs to myself by writing about them in blogs. 

I learn from others' work that they share, but I also try to learn for others by writing up my experiences and putting them online. 

transition: so I've shown a lot of what the OHI does with open data science tools, so it is fine time time to intro you to the OHI team
