...
OR:
I'm a scientist
we think of science as being this pretty streamlined thing (new studies come out...) (pic of a wave?)
but it really operates in pockets, labs. (ripples)
labs are often around a theme or topic. My PhD lab was like this.
We were a squid lab, broadly inteeresteed in xyz. Some things we focused on were xyz. 
...
And even though we are part of a lab, part of a group that is unified around science, it can be really lonely and isolating when it comes to data bc we don't have the skills, mindset, or support. 
Star Wars.  
...
---
# Pics here.
1. team lead valued & supported us. BH
2. We were a team
3. someone jazzed about R

???

Our research group was unique/strong in several ways. 
...
# https://www.nature.com/articles/s41559-017-0160/tables/1
```
...
took us a long time to nail down. --- And also have Openscapes do this 
