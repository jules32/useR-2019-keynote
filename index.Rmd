...
Teams to me means rings of people you respect, innovate with, and can rely upon. It does not have to be limited to a certain deliverable, location, discipline or anything else really. 

This definition works because shared workflows like tidyverse and GitHub mean that even when you aren't working on the same project or interest, you have the same skills and are equipped to help each other out. 
...
We can physically work on the same document in Google Drive or in GitHub, and also think together at the same time. 

These tools let us co-develop things, share early drafts, and we can constantly giving feedback and iterating with each other. 

transition: But it is something you have to feel safe doing. 
...
This all really centers on kindness, where we respect each other and each other's time. 

We have all personally had to get comfortable with sharing things before they are perfect and being vulnerable to critique, which gets easier when you can assume the best intentions from anyone's feedback. 

And something we also have to do is get comfortable asking for and accepting help (which is something I struggle with)
...
But this has resulted in a really positive team culture, where we are comfortable with trying new things & learning from failure

And we prioritize social time, obviously, since all of our team pictures are at happy hour. 

But seriously, getting along well together builds resilience into our team and has helped avoid burnout.
...
This includes a deliberate focus on creating a safe and welcoming space where we are all engaged through group video calls, smaller breakout groups, and through a shared Google Doc. 
...
Our Ocean Health Index team calls these weekly meeting "Seaside chats", and the Openscapes labs have Bayside, Bluffside, Seaside, and Fishbowl Chats. 

It's a place to their lab group to develop shared systems for the lab start weaving these practices into their every day work

Some labs have also done hackathons, like we do in Ocean Health Index, where we will all drop our own projects and come together for a day or an afternoon to do something that will benefit the whole group. 
...
These are the 7 Champions, and I mentor them one-on-one each month in addition to the cohort calls. 

The most important thing for them to learn is that they do not have to become experts in open data science in order to support their labs and champion it more broadly. 

And this is important to release them of that expectation and this potential anxiety, because they are already overworked and doing really impactful work. 

They are presenting their research to the US Senate, they are getting tenure, they are winning international awards and grants, they are teaching, they are leading field work abroad, and they do not need to also feel like then need to learn what a pull request is in order to set their labs on a good track. 
...
I'm just so excited that they feel this way. 
...
```{r allison-tidytuesday, out.width = '70%'}
...
transition: Those are just some stories of the teamwork, leadership, and community involvement that the Openscapes champions have been engaged in. And the more I reflect on this the more I realized is that —
...
You really need both. Trying to engage solely with open data science without teamwork can be lonely and deflating. And only as a team but without the best collaborative software can be inefficient, especially in science.
...
transition: Welcome people with smiles, with emojis, and with body language, like the pacman rule, which is when you leave space for someonee else to join when you're chatting in a group.
...
Everyone is starting from didfferent places, so progress differs, and outcomes differ. Someone might start using github for the first time. Or google drive. Some might start a #tidytuesday coding club or 
...
.pull-right[
```{r openscapessafd, out.width = '180%'}
knitr::include_graphics("img/allison-poppies.jpg")
```

#### Find me for stickers... <img src="img/openscapes-hex.png" alt="rstudio" style="float:right;width:80px;"/> <img src="img/ohi-hex.png" alt="rstudio" style="float:right;width:80px;"/>
]
