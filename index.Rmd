...
???
And it's been really in the last year that I've been able to operationalize this publication and create a program to help teams actually acheive it. TODO
...
Openscapes is a mentorshipt program for reaeearch groups.
...
And I'll tell you about the program as we go, but I did want to introduce the people who have 

---
# champions-web
Should I dd this? ponder/
---
# zoom

because where they started with openscapes is where most research broups start. iand that is they are studying env stystems that are incredibly important, like how climate change affects the food we eat

and they are communicating their results to really imp audiences

but they are largely on their own when it comes to data. 




transition: So let me tell you about it through these lessons learned
...
And I'll also finally define what I mean by these things because I'm aware it has been mysterious

---
class: inverse, center, middle
# Open data science is a mindset

### expect a better way • build confidence & willingness • leverage the internet for science JENNY
...
These are most of the Openscapes participants, who we call Champions.

We meet over a period of months through remote calls. This first cohort here included participants from 7 labs, with leadership and lab members from each research group. 

---
# Expect there is a better way

???
A big part of Openscapes is creating welcoming entryways for scientists, and we start off by demystifying concepts and helping people see entryways in their own work.
...
In our first cohort we had scientists... some story about parasites TODO
...
This depiction of data science has these clear steps is the beginning of a way for scientists to see data science as something relevant to their work.
...
So for example, I spent months trying to create a way to format dates from scratch in Matlab. And it's because since my data were from squid I thought that this was a squid challenge. I couldn't distinguish science from data science. 

And because I couldn't separate them I didn't have the expectation that formatting dates was something that people had encountered before.

I didn't have any idea of what was possible, and I also didn't have the vocabulary to articulate our struggles and ask for help. 

transition: But it's not just me, I see this a lot with the folks I work with. 


---
# TODO does this screenshot work
```{r breakfast, out.width = '100%', fig.align='center'}
knitr::include_graphics("img/data-science-training-breakfast.png")
```

.footnote[
source: [ohi-science.org/data-science-training](http://ohi-science.org/data-science-training/rstudio.html)
]

???


When I teach Carpentries workshops we talk about this in terms of expectations. 
...
The next is build confidence & willingness to engagee. And open science is a big part of this. 
...
---
# Leverage the internet for science
...
I can actually be pretty resistant to new software 
...
---
# Working openly TODO this means
...
---
# Leadership <img src="img/ohi-hex.png" alt="rstudio" style="float:right;width:100px;"/>
...
---
# allison ggplot monster

.footnote[
art: [@allison_horst]<br>
blog: [openscapes.org]
]
