...
Open data science is the Force that enables us as scientists to do better science in less time. 
...
And open data science helped us take less time to repeat these maps every year — 
...
Because we realized we couldn't reproduce our own work otherwise, and the transition was pretty painful. 

To prevent other scientists from this pain and accelerate others getting on the right track, we shared our story
...
Because research looks like this —
...
In our education we rarely learn how to work responsibly with data. 
